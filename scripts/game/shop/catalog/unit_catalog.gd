...
static var CATALOG = {
	"blue_ant": {
		"name": "Blue Ant",
		"description": "Balanced unit with \ngood damage and defense",
		"cost": 8,
	...
	"red_ant": {
		"name": "Red Ant",
		"description": "Offensive unit with \ndecent damage",
		"cost": 12,
	...
	"fly": {
		"name": "Fly",
		"description": "Unit with great \nmovement",
		"cost": 12,
		"scene": "res://scenes/bugs/fly.tscn",
		"rarity": "uncommon"
	},
	"warrior_ant": {
		"name": "Warrior Ant",
		"description": "Tank unit with \ngreat damage",
		"cost": 15,
		"scene": "res://scenes/bugs/warrior_ant.tscn",
		"rarity": "uncommon"
	},
	"termite": {
		"name": "Termite",
		"description": "Balanced unit with \ngood damage",
		"cost": 10,
		"scene": "res://scenes/bugs/termite.tscn",
		"rarity": "common"
	},
}
